...
public class BoundingFrustum : MonoBehaviour {
	...
	#region Public fields 
		...
		/// <summary>
		/// Ordering: [0] = Far Bottom Left, [1] = Far Bottom Right  , [2] = Far Top Right, [3] = Far Top Left, 
		...
		public void Update( Camera camera, float farClipPlane )
		{
			...
			_planes[ 0 ] = new Plane( _corners[ 4 ], _corners[ 3 ], _corners[ 0 ] );
			_planes[ 1 ] = new Plane( _corners[ 6 ], _corners[ 1 ], _corners[ 2 ] );
			_planes[ 2 ] = new Plane( _corners[ 5 ], _corners[ 0 ], _corners[ 1 ] );
			_planes[ 3 ] = new Plane( _corners[ 1 ], _corners[ 2 ], _corners[ 3 ] );
		...
		public void Update( Vector3 position, Quaternion orientation, float fov, float nearClipPlane, float farClipPlane, float aspect )
		{
			...
			_planes[ 1 ] = new Plane( _corners[ 6 ], _corners[ 1 ], _corners[ 2 ] );
			_planes[ 2 ] = new Plane( _corners[ 5 ], _corners[ 0 ], _corners[ 1 ] );
			_planes[ 3 ] = new Plane( _corners[ 7 ], _corners[ 2 ], _corners[ 3 ] );
		...
		private void calculateFrustumCornersPerspective( ref Vector3 position, ref Quaternion orientation, float fov, float nearClipPlane, float farClipPlane, float aspect )
		{
			...
			_corners[ 1 ] = position + orientation * bottomRight; 
			_corners[ 2 ] = position + orientation * topRight;
			_corners[ 3 ] = position + orientation * topLeft;
			...
			_corners[ 5 ] = position + orientation * bottomRight;
			_corners[ 6 ] = position + orientation * topRight;
			_corners[ 7 ] = position + orientation * topLeft;
		}
